...
function incrementAndDisplayCount() {
  ...
  if (typeof(Storage) !== "undefined") {
      ...
      // If it's the first visit, set count to 1, otherwise increment it
      if (!count) {
          count = 1;
      } else {
      ...
      document.getElementById("counter").textContent = "N/A (Local Storage not supported)";
  }

}

// Call the function to increment and display the count on page load
window.onload = incrementAndDisplayCount;
 
// visit counter END effect index.html